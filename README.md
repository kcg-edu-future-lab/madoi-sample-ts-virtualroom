# madoi-sample-ts-virtualroom

Madoiを利用したシンプルな仮想オフィスのサンプルです。
...
```bash
git clone https://github.com/kcg-edu-future-lab/madoi-sample-ts-virtualroom
cd madoi-sample-ts-virtualroom
```
